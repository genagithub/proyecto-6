...
app.layout =  html.Div(id="body", className="e6_body", children=[
    ...
    html.A(href="https://github.com/genagithub/proyecto-6/blob/main/forecating_de_ventas_para_campa%C3%B1as_de_marketing.ipynb", children=[html.H2("Pronóstico de campañas de Marketing", id="H2", className="e6_title")]),
