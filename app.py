...
def update_forecast(slct_var, slct_campaign, slct_company, slct_channel, slct_location):
    ...
    forecasting.add_trace(go.Scatter(x=df_ts_recent["Date"], y=df_ts_recent["Conversions"], mode="lines", fill="tozeroy", fillcolor="rgba(0, 0, 255, 0.15)", name="Conversiones (último trimestre)"))
